    ...
    if ($loan_query->execute()) {
        ...
        while ($loan_info = $loan_result->fetch_assoc()) {
            ...
            $loan_security_info = [
                ...
                'Original Signed Application Form' => !empty($loan_info['signed_application_form']) ? $loan_info['signed_application_form'] : 'N/A',
            ];
    ...
    <ul>
        <?php foreach ($profile['loan_security_info'] as $label => $value): ?>
            <li>
                ...
                <?php if ($label === 'Collateral Pic 1' || $label === 'Collateral Pic 2' || $label === 'Original Signed Application Form'): ?>
                    <?php if ($value !== 'N/A'): ?>
                        <a href="<?php echo htmlspecialchars($value, ENT_QUOTES, 'UTF-8'); ?>" target="_blank">View <?php echo htmlspecialchars($label); ?></a>
                    <?php else: ?>
                        N/A
                    <?php endif; ?>
                <?php else: ?>
