...
<li>
    ...
    <?php echo !empty($loan_data['loan_balance']) ? number_format($loan_data['loan_balance'], 2) : 'N/A'; ?>
                                ...
                                <div class="profile-info">
                                    ...
                                    <ul>
                                    <li>
    <span>Guarantor Phone Number:</span>
    <?php echo !empty($client_data['guarantor_national_id']) ? htmlspecialchars($client_data['guarantor_national_id']) : 'N/A'; ?>
</li>
<li>
    <span>Guarantor Residence:</span>
    <?php echo !empty($client_data['guarantor_residence_nearest_road']) ? htmlspecialchars($client_data['guarantor_residence_nearest_road']) : 'N/A'; ?>
</li>
<li>
    <span>Next of Kin Name:</span>
    <?php echo !empty($client_data['next_of_kin_name']) ? htmlspecialchars($client_data['next_of_kin_name']) : 'N/A'; ?>
</li>
<li>
    <span>Guarantor ID Front:</span>
    <?php if (!empty($client_data['guarantor_id_photo_front'])): ?>
        <a href="<?php echo htmlspecialchars($client_data['guarantor_id_photo_front']); ?>" target="_blank">View Photo</a>
    <?php else: ?>
        N/A
    <?php endif; ?>
</li>
<li>
    ...
    <?php if (!empty($client_data['guarantor_id_photo_back'])): ?>
        <a href="<?php echo htmlspecialchars($client_data['guarantor_id_photo_back']); ?>" target="_blank">View Photo</a>
    <?php else: ?>
        N/A
    <?php endif; ?>
</li>
<li>
    <span>Guarantor Passport Photo:</span>
    <?php if (!empty($client_data['guarantor_passport_photo'])): ?>
        <a href="<?php echo htmlspecialchars($client_data['guarantor_passport_photo']); ?>" target="_blank">View Photo</a>
    <?php else: ?>
        N/A
    <?php endif; ?>
</li>
...
<li>
    ...
    <?php echo !empty($client_data['next_of_kin_phone_number']) ? htmlspecialchars($client_data['next_of_kin_phone_number']) : 'N/A'; ?>
</li>
<li>
    <span>Next of Kin Residence:</span>
    <?php echo !empty($client_data['next_of_kin_residence']) ? htmlspecialchars($client_data['next_of_kin_residence']) : 'N/A'; ?>
</li>                                    </ul>
                                </div>
                                <div class="profile-info">
