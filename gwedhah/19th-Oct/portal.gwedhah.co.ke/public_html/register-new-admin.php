...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        if ($stmt->execute()) {
            ...
            $message .= "You can log in to your dashboard at https://portal.gwedhah.co.ke as $role using your email and this temporary password.\n\n";
            ...
            <div class="col-md-6 col-lg-5">
                <div class="login-box bg-white box-shadow border-radius-10">
                    <div class="login-title">
                        <h2 class="text-center text-primary">Register for Gwedhah Investments -  LMS</h2>
                    </div>
