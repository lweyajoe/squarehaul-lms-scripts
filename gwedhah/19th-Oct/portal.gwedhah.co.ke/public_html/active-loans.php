        ...
        <div class="xs-pd-20-10 pd-ltr-20">
            <div class="min-height-200px">
                ...
                <div class="card-box mb-30">
                    <div class="pd-20">
                        <h4 class="text-blue h4">Active Loans</h4>
                    </div>
                    <div class="pb-20">
                        <table class="data-table table stripe hover nowrap">
                            ...
                            <tbody>
                                ...
                                if ($user_role == 'admin') {
                                    ...
                                    $sql = "SELECT 
                                            ...
                                            LEFT JOIN 
                                                payments p ON a.loan_id = p.loan_id
                                            WHERE 
                                                a.loan_status = 'Active' AND a.national_id = ?
                                            GROUP BY 
                                                a.loan_id, c.first_name, a.national_id, a.onboarding_officer, 
                                                a.requested_amount, a.collateral_value";
                                } elseif ($user_role == 'manager') {
                                    $sql = "SELECT 
                                            ...
                                            LEFT JOIN 
                                                payments p ON a.loan_id = p.loan_id
                                            WHERE 
                                                a.loan_status = 'Active' AND a.onboarding_officer = ?
                                            GROUP BY 
                                                a.loan_id, c.first_name, a.national_id, a.onboarding_officer, 
                                                a.requested_amount, a.collateral_value";
                                }
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    echo "<tr><td colspan='8'>No active loans found</td></tr>";
                                }
                                $stmt->close();
                                ?>
                            </tbody>
