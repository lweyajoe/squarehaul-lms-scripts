        ...
        <div class="xs-pd-20-10 pd-ltr-20">
            <div class="min-height-200px">
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Defaulted Loans DataTable</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="card-box mb-30">
                    <div class="pd-20">
                        <h4 class="text-blue h4">Defaulted Loans</h4>
                    </div>
                    <div class="pb-20">
                        <table class="data-table table stripe hover nowrap">
                            ...
                            <tbody>
                                ...
                                if ($user_role == 'admin') {
                                    ...
                                    $sql = "SELECT 
                                            ...
                                            LEFT JOIN 
                                                payments p ON a.loan_id = p.loan_id
                                            WHERE 
                                                a.loan_status = 'Defaulted' AND a.national_id = ?
                                            GROUP BY 
                                                a.loan_id, c.first_name, a.national_id, a.onboarding_officer, 
                                                a.requested_amount, a.collateral_value, a.created_at, a.status_change";
                                } elseif ($user_role == 'manager') {
                                    $sql = "SELECT 
                                            ...
                                            LEFT JOIN 
                                                payments p ON a.loan_id = p.loan_id
                                            WHERE 
                                                a.loan_status = 'Defaulted' AND a.onboarding_officer = ?
                                            GROUP BY 
                                                a.loan_id, c.first_name, a.national_id, a.onboarding_officer, 
                                                a.requested_amount, a.collateral_value, a.created_at, a.status_change";
                                }
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    echo "<tr><td colspan='8'>No defaulted loans found</td></tr>";
                                }
                                $stmt->close();
                                ?>
                            </tbody>
